			...
			<div class="main-block w-100">
				<div class="sub-header d-flex align-items-end w-100">
					...
					<div class="opt-modality d-flex align-items-center justify-content-center"
						v-for="(modalidade, index) in modalidades" :key="index">
				...
				<div class="submain-block ">
					<div v-if="1 == 1" class="card-space d-flex flex-wrap align-items-start justify-content-start">
						<CardModality icon='<i class="fa-light fa-user-tie"></i>' title="Categoria Sub-15" day="Sábados"
							hour="Das 10:00 ás 12:30" professor="Mauricio" color="#0D6EFD" img="futebol.png" />
						<CardModality icon='<i class="fa-light fa-user-tie"></i>' title="Categoria Sub-15" day="Sábados"
							hour="Das 10:00 ás 12:30" professor="Mauricio" color="#FF6607" img="basquete.png" />
						<CardModality icon='<i class="fa-light fa-user-tie"></i>' title="Categoria Sub-15" day="Sábados"
							hour="Das 10:00 ás 12:30" professor="Mauricio" color="#FFC107" img="volei.png" />
						<CardModality icon='<i class="fa-light fa-user-tie"></i>' title="Categoria Sub-15" day="Sábados"
							hour="Das 10:00 ás 12:30" professor="Mauricio" color="#2F7345" img="futebol.png" />
					</div>
...
#modalities .sub-header .opt-modality:hover {
	background-color: #9292931c;
	cursor: pointer;
}

#modalities .sub-header .opt-modality.active:hover {
